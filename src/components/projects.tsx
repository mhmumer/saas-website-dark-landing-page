...
import Farfetch from "../assets/images/farfetch.png";
          ...
          <div className="group relative   sm:py-10 sm:px-10 rounded-3xl   px-16 overflow-hidden">
            <div className="max-w-7xl flex flex-row  relative">
              <Image
                src={SharkBlankie}
                alt=""
                className="sm:w-[18rem] sm:h-48 lg:w-[32rem] lg:h-80 rounded-lg mr-6"
              />
          ...
          <div className="group relative backdrop-blur  py-10 px-12   ">
            <div className="max-w-7xl flex relative">
              ...
              <Image
                src={Dastaan}
                alt=""
                className="sm:w-[18rem] sm:h-48 lg:w-[32rem] lg:h-80 rounded-xl ml-6"
              />
              <Link
