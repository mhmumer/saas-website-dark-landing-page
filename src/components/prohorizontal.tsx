...
const Example = () => {
  return (
     <div className="
     max-w-[80rem] mx-auto items-center justify-center">
...
const HorizontalScrollCarousel = () => {
  ...
  return (
    <section ref={targetRef} className="relative h-[140vh] ">
      <div className="sticky top-0 flex h-[1500px] items-center overflow-hidden">
...
const Card = ({ card }:{card:any}) => {
  return (
    <div
      key={card.id}
      className="group relative h-[300px] w-[430px] overflow-hidden bg-neutral-200 rounded-lg"
    >
